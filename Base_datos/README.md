...
```text
biblioteca-database-repo  -> PostgreSQL en localhost:25433
biblioteca-backend-repo   -> API en localhost:8080, conectada a PostgreSQL
biblioteca-frontend-repo  -> Web en localhost:3000, conectada al backend
```
